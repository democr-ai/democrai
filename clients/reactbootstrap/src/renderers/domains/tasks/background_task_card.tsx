...
export const BackgroundTaskCard: React.FC<{
  ...
  return (
    <div className="a2ui-background-task-card d-flex flex-column gap-2 p-3 border bg-white">
      <div className="d-flex align-items-center gap-2">
        <i className={cn(iconClass, colorClass, 'fs-5', (status === 'running' || status === 'started') && 'ri-spin')} />
      ...
      {showProgress && <div className="xsmall text-muted text-end">{progress}%</div>}
    </div>
  );
};
