...
import { Button, ButtonGroup, Badge, Nav, NavItem, NavLink } from 'design-react-kit';
...
export const Calendar: React.FC<any> = ({
  ...
  return (
    <div style={parseStyle(style)} className="a2ui-calendar calendar-container bg-white p-3 border">
      <Nav tabs activeKey={activeView} className="a2ui-tabs-nav mb-3">
        {[
          ...
          <NavItem key={v.key}>
            <NavLink
              ...
              onClick={(e) => { e.preventDefault(); switchView(v.key as any); }}
            >
              {v.label}
            </NavLink>
          </NavItem>
