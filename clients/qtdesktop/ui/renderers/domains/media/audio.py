...
from .audio_widget import AudioPlayerWidget
from .common import (
...
class AudioRenderer(BaseRenderer):
    ...
    def render(
        ...
        widget = AudioPlayerWidget(
            ...
            height=_int_value(props.get("height"), 180),
        ...
        setattr(widget, "_dmc_audio_app_instance", app_instance)
    ...
    def update_widget_property(self, widget: QWidget, prop: str, value: Any) -> None:
        if prop == "source" and hasattr(widget, "set_source"):
            widget.set_source(
                _normalize_media_source(
                    _literal(value),
                    getattr(widget, "_dmc_audio_app_instance", None),
                )
            )
            return
