...
async def render(_params: dict, _session: dict):
    ...
    builder.merge(sdk.ui.load("ui/yaml/flow_external_path"), components=True)
    builder.set_data(
        "/components_flow/external_path/api",
        [
    ...
    preview.set_children(["components_flow_external_path_root"])
