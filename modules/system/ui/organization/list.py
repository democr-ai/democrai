...
from modules.system.utils.ui.dataproviders import organization_table_provider
...
async def render(params: dict, session: dict):
    ...
    page_builder = sdk.ui.load("utils/ui/yaml/organization/list")
    builder.set_data("/system/organization/list", organization_table_provider(sdk))
