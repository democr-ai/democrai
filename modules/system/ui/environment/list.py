...
from modules.system.utils.ui.dataproviders import environment_table_provider
...
async def render(params: dict, session: dict):
    ...
    page_builder = sdk.ui.load("utils/ui/yaml/environment/list")
    builder.set_data("/system/environment/list", environment_table_provider(sdk))
