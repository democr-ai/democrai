...
from modules.system.utils.ui.dataproviders import mcp_table_provider


async def render(params: dict, session: dict):
    builder = sdk.ui.Builder()
    _, preview_id = await shared_layout(builder)
    page_builder = sdk.ui.load("utils/ui/yaml/mcp/list")
    builder.set_data("/system/mcp/list", mcp_table_provider(sdk))
